...
rm.showRightMenu = function (isTrue) {
...
function stopMaskScroll() {
  ...
  if (document.getElementById("rightMenu")) {
    var _xscroll = document.getElementById("rightMenu");

    _xscroll.addEventListener("mousewheel", function (e) {
      removeRightMenu();
    }, false);
  }
}
...
var defaultEncoding = translate.defaultEncoding;
/* 網站默認語言，1: 繁體中文, 2: 簡體中文 */

var translateDelay = translate.translateDelay;
/* 延遲時間,若不在前, 要設定延遲翻譯時間, 如100表示100ms,默認為0 */

var msgToTraditionalChinese = translate.msgToTraditionalChinese;
/* 此處可以更改為你想要顯示的文字 */

var msgToSimplifiedChinese = translate.msgToSimplifiedChinese;
/* 同上，但兩處均不建議更改 */
